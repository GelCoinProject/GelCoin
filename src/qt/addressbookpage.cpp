    ...
    tab(tab)
{
    ...
    {
    case SendingTab:
        ui->labelExplanation->setText(tr("These are your GelCoin addresses for sending payments. Always check the amount and the receiving address before sending coins."));
