...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all GelCoin related functionality
...
/*
    ...
    allow endless transaction that would bloat GelCoin and make it unusable. To
...
void ThreadCheckPrivateSendServer(CConnman& connman)
{
    ...
    RenameThread("gelcoin-ps-server");
