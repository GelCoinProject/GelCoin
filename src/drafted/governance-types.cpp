...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "GelCoinNetwork") type = GelCoinNetwork;
    if(strType == "GelCoinNetworkVariable") type = GelCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == GelCoinNetwork) s = "GelCoinNetwork";
    if(type == GelCoinNetworkVariable) s = "GelCoinNetworkVariable";
