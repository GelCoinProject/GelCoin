...
<<<<<<< HEAD
        ...
        QString header = tr("Usage:") + "\n" +
            "  gelcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the GelCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 GEL, 0.1 GEL, 1 GEL and 10 GEL -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://gelcoinpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://gelcoinpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
