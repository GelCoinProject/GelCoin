...
#define BOOST_TEST_MODULE GelCoin Test Suite

#include "test_gelcoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_gelcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
