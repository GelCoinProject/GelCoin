...
This mechanism has been integrated into Bitcore-Node-GelCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gelcoinpay/insight-api-gelcoin#web-socket-api](https://github.com/gelcoinpay/insight-api-gelcoin#web-socket-api)
* API: [https://github.com/gelcoinpay/insight-api-gelcoin#instantsend-transactions](https://github.com/gelcoinpay/insight-api-gelcoin#instantsend-transactions)
...
By default, the GelCoin daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the GelCoin daemon:
